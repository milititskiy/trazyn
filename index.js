...
var buildName = task.getVariable('build.buildNumber');
console.log('Build Name', buildName);
var TotalFailedTests;
function sendMail() {
...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            fs.readdir(jsonFolder, 'utf-8', function read(err, files) {
                files.forEach(function (file) {
                    // console.log(file);
                    fs.readFile(path.join(jsonFolder, file), function (err, data) {
                        if (err)
                            throw err;
                        var parsed = JSON.parse(data).run.stats;
                        //console.log(parsed);
                        var sum = 0;
...
run();
>>>>>>> 2d5af41c017dbf2b3365ba7332cad1e05a3eab4b
